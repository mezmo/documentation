...
OpenTelemetry support is enabled by default via the `otel` feature for the
`aura` binary, covering both the CLI and `aura webserver`. Configure your OTLP endpoint using standard
