...
This page covers Aura as an A2A server that receives requests. For an Aura agent that calls other Aura agents, such as a hub delegating to per-environment spokes, see [Calling Remote Agents](/aura/a2a-remote-agents).
