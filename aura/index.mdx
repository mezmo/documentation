...
description: "AURA is an open source SRE agent for investigating production incidents, with scoped tool access, human approval gates, and end-to-end OpenTelemetry tracing."
---
...
<div style={{ display: 'flex', flexWrap: 'wrap', gap: '12px', marginTop: '24px' }}>
  <a href="/aura/quickstart" style={{ display: 'inline-flex', alignItems: 'center', borderRadius: '8px', background: '#503A82', color: '#ffffff', padding: '10px 18px', fontSize: '14px', fontWeight: 600, textDecoration: 'none' }}>
    Try the quickstart
  </a>
  <a href="https://github.com/mezmo/aura" style={{ display: 'inline-flex', alignItems: 'center', borderRadius: '8px', background: '#f3eefc', color: '#503A82', padding: '10px 18px', fontSize: '14px', fontWeight: 600, textDecoration: 'none' }}>
