...
- When no window is known, it shows a bare count with no percentage.
- The meter is absent in orchestrated conversations, because usage there mixes several agent contexts.
