...
1. Pick a server from the built-in catalog (Mezmo, PagerDuty, Datadog, Kubernetes, or You.com — see the [You.com guide](/aura/youcom-web-search) for the keyless search server), or configure a custom server.
