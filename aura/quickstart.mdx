...
This pipes a remote script to `bash`; to review the script or its checksum behavior first, see the [Installation](/aura/installation#run-the-install-script) page.
