  ...
  <div className="mt-8">
    <Steps>
      <Step title="Create your account">
        <a href="https://www.mezmo.com/contact">Contact our team</a> if you need access to Mezmo. Once you have access, set up your organization and review the basics in the <a href="/docs/mezmo-quick-start-guide">Log Management quick start</a>.
      </Step>
...
<section className="mx-auto mt-16 max-w-7xl px-4 sm:px-6 lg:px-8">
  ...
  <div className="mt-8">
    <CardGroup cols={3}>
      <Card title="Authentication" icon="key" href="/docs/api#authenticating-with-the-api" cta="Set up keys">
