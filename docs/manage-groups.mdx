---
title: "Manage Groups"
description: "Create, edit, and delete groups that restrict which logs members can access using search queries in your Mezmo organization."
---
...
- Only [Members](/docs/manage-access) can be added to Groups. Owners and Admins can not be added to groups.
...
To learn more about creating queries, see [Search](/docs/search-and-filter#simple-search).

<Frame caption="Edit the group name, add members and use queries to set access scope.">
  ![Image](/images/docs/fqsh19eceovf9sfxsdbwapdecb0kbtptil005h6ec40bkx2bt98bcozuzgte9bwa.png)
</Frame>
