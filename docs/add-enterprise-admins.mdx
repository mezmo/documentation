...
description: "Grant Super Admin privileges from the General page so users can view the Enterprise Dashboard, manage child organizations, and set sign-in options."
---
