...
Once you have access to Mezmo, you can create or join an Organization. An Organization can have an [ingestion key](/docs/ingestion-key) that you use to send logs to Mezmo for storage and analysis. If you need a new account, [contact our team](https://www.mezmo.com/contact); self-service free trials are no longer available.
