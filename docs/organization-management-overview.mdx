...
An Organization name can be up to 80 characters.
...
Changing the Organization name updates the display name of the Organization in Mezmo for all members. An Organization name can be up to 80 characters.
