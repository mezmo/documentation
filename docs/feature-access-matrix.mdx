...
description: "Reference table mapping Mezmo features to the Read-only, Basic, Admin, and Owner roles that can access each one."
---
...
All roles can view CORS Origins. Adding or removing an allowed origin requires the Admin or Owner role.
