...
description: "Configure sign-in policies, SAML SSO, organization discoverability, and login methods for child organizations in a Mezmo Enterprise account."
---
...
<Frame caption="The control to enable child organization discoverability in the Enterprise dashboard">
  ![Image](/images/docs/j80pl27kpcrj1rrb7l3wlfsrcby8hqlzkfhuu5vlq5zer1a74lnvwa5s1kxv88ru.png)
</Frame>
