...
description: "Invite, edit, and remove members, assign roles and groups, and handle join requests for your Mezmo organization's team."
---
...
The Manage Team screen shows each Mezmo Organization member with their email, groups, and [role](/docs/rbac). You can also see how many people your plan lets you have on your team.
...
3. Select the [role](/docs/rbac) that the member will be assigned to.
