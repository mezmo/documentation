...
<Note>
Owners and Admins of the organization can turn the **Store and Show Raw Line** toggle on and off. Other users can still see the toggle, but it appears in a disabled, read-only state that they cannot change.
</Note>
