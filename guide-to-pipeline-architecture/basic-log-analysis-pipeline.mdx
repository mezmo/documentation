...
With a Mezmo account that has Telemetry Pipelines enabled, you can add the [Mezmo Log Analysis Destination](/telemetry-pipelines/mezmo-destination) to your Pipeline to use Log Analysis features. This topic shows you how to configure and use the Log Analysis Destination with a [Demo Logs Source](/telemetry-pipelines/demo-logs-source). If you need access, [contact our team](https://www.mezmo.com/contact).
...
<Frame caption="A basic example of a Pipeline Source sending telemetry data directly to Mezmo Log Analysis">
  ![Image](/images/guide-to-pipeline-architecture/s2t5oeuozd80ihp9wktiz8ao9x1t5v2vguyjviomlzai8dbohsy2bntfuwmpy1kt.png)
</Frame>
...
<Frame caption="Click the Log Analysis icon to open the Log Analysis Viewer as shown in this screenshot">
  ![Image](/images/guide-to-pipeline-architecture/bockslid20yu3drgd34yzbth6z3ymg40znoasvpe3yoyurcvqjrusojqvxxgl9cj.png)
</Frame>
