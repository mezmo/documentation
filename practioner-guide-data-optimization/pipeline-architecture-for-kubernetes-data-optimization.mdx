...
description: "An example pipeline that filters, converts to metrics, aggregates, and routes Kubernetes container logs while archiving originals for compliance."
---
