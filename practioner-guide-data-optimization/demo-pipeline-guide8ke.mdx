...
description: "Tour the Demo Pipeline's sources, Route and Filter processors, and Encrypt Field processor for handling credit card transaction data."
---

If a Demo Pipeline is available in your Mezmo organization, you can use it to explore Pipeline features and functionality. This topic describes its architecture, along with highlights of its Sources, Processors, and Destinations.
...
<Frame caption="The Demo Pipeline in the Mezmo Web App">
  ![Image](/images/shared/im66j3opusetyr53m3iuftld60g390jnzf0ftzsh8qjfbfchjurq1wbzs6m1xnwl.png)
</Frame>
...
<Frame caption="The Pipeline Tap view for the Financial Data Source">
  ![Image](/images/shared/bc8p4m7x3xf95iqfdfpj3l5mda275qrshabnmgrpqeggawbl30hwpfi02yubzl1o.png)
</Frame>

#### JSON Data

<Frame caption="The Pipeline Tap view for the JSON Data Source">
  ![Image](/images/shared/elcklviivsaw1vgqdsm8ptf4krnjxtpys5d1hudx3lzas5aq6x2zkzrb3fa87eun.png)
</Frame>
