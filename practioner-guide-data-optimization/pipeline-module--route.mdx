...
description: "Build a routing group that uses a Route Processor and conditional statements to send financial, JSON, and Apache data down separate processing chains."
---
...
![](/images/shared/3nxo3tdofxzio0vl8y9wi9pp9ix6nnd83b5iz3mr6xjcwinx11san4fi9e5u6ju8.png)
