...
<Frame caption="Changing the operational state of a Pipeline in the Mezmo Web App">
  ![Image](/images/telemetry-pipelines/pt5iwjtqwchdc01qpcxnbq117svndul3xe9yk91voub7983l9p0zz7zegmikmbm1.png)
</Frame>
...
<Frame caption="This screenshot shows the configuration of the Script Execution Processor to get the operational state and add it to the message">
  ![Image](/images/telemetry-pipelines/40gfiueor5pb549yep90zvsk3w7o91nmljiy6luqfkphydprkqscm18h4vkztzn5.png)
</Frame>
...
<Frame caption="This screenshot shows the configuration of the conditions in the Route Processor for both Monitoring and Incident Modes">
  ![Image](/images/telemetry-pipelines/whbmfgiai2ok2ahywhgjgf733i7odvhbu2alv8wil8px9k1dzvlcr6eybqtdd8my.png)
</Frame>
...
[This interactive demo](https://capture.navattic.com/clzsclm8e000009laaj3zeyyn) illustrates a telemetry pipeline that is configured to respond to a Datadog data volume spike incident. 
