...
| Function | Description | 
| ---- | ---- | 
| `getPipelineStateVariable("<name>")` | Returns the current value of the named Pipeline state variable, such as `operational_state`. | 
| `setPipelineStateVariable("<name>", "<value>")` | Sets the named Pipeline state variable to the given value. Anyone who can update the Pipeline can change its state. | 
