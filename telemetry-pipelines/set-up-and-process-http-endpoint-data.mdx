...
description: "Walkthrough for configuring an HTTP endpoint pipeline source, sending test data with cURL, adding a processor, and routing the data to a destination."
---
