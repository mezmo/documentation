...
There is no specific configuration values needed when adding this source to your pipeline.  The OpenTelemetry source uses a shared endpoint to ingest data.  It will route data to your pipeline based on your [Ingestion key](https://docs.mezmo.com/docs/ingestion-key#ingestion-keys) (`apikey`).
