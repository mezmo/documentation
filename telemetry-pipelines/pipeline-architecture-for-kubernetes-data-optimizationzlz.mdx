...
description: "Walk-through of a Pipeline that transforms Kubernetes telemetry into metrics for observability tools while retaining original data in storage."
---
