...
<Note>Additional notification services can appear when related features are enabled for your account. If your account has AI Investigations enabled, you can select the **Mezmo AURA Investigation** service to start an [AI Investigation](/docs/ai-investigations) when the alert fires.</Note>
