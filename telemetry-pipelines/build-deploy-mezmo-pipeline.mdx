...
description: "Step-by-step instructions to build a Pipeline from Sources, Destinations, and Processors in the Mezmo Web App, then deploy and view it."
---
...
2. Click **Deploy Pipeline**. Deploying a pipeline requires the **Manage** permission level for Pipelines, which you set on a role as described in [Set Pipeline Access](/telemetry-pipelines/set-pipeline-access).
