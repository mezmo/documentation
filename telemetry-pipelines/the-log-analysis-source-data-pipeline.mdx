...
<Frame caption="Schematic of the LASD Pipeline showing 1) the Mezmo Log Analysis Source 2) the Route Processor for Kubernetes Enrichment 3) the Drop Fields Processor 4) the Route Processor for Bad LInes 5) the Mezmo Log Analysis Destination 6)the Blackhole Destination">
  ![Image](/images/shared/d8jizv5xta6tdgr3d1z7zuwztw49l7ii3pmrxksl8lbtprpcvdqsodmimwq0ibx6.png)
</Frame>
