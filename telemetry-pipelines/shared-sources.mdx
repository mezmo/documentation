...
![A Shared HTTP Source, showing the Log Types detected by automated parsing. Each Log Type can be sent along an independent processing chain.](/images/telemetry-pipelines/kx3y0kgd7y9lbzxkkgd8nzcb14duqh6q2cetltt3hdrbhcq3zlz6em4iccoi49bu.png)
