...
![Prompt for the vector command to tap the selected node](/images/mezmo-edge/qtv4nklxsqmfuyqk2bjq822dkl0iyp03akr2ctbldy3aozuo5ycz6tv0wk4i6h8n.png)
...
![Using `outputEventsByComponentIdPatterns` to inspect data for the http source shown in the first example of this topic](/images/mezmo-edge/l2d72jt8qpyskdetca6s6o27qyrl4hjd0tpytx27kfprinq1dwr2z4ka6bdiizux.png)
...
![Use **Inspect** to find the component ID](/images/mezmo-edge/cxnux4taxrj9j0sfrocnhfq5xoq36cphpzltq7d7m3iiwmcpmycs8ujdeiuj8s71.jpg)
...
![The `data-nodeid`for the component highlighted in blue](/images/mezmo-edge/ntlehgsyzt3pf5r6h3xyul6o57952ka20z4is310fi21ktkuaufpovcs2q8hn2tv.png)
...
![The child nodes of a parent multi-output component](/images/mezmo-edge/fokn3su7qfkk3s3ocie1433wla4cya6u5rsjh0koynl1atxrk5m8xa1epa8amzic.png)
...
![The GraphQL Playground](/images/mezmo-edge/2psoy3ab00uquyqmyvkdd2g710sbgfb3dgt0px5t4z7xs9f7c24mt6lcsxelek0m.png)
